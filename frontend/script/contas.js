...
const updateIcon = () => {
    const select = document.getElementById('nomeConta');
...
document.getElementById('nomeConta').addEventListener('change', updateIcon);
...
const resetModal = () => {
    ...
    document.getElementById('nomeConta').value = defaultBanco; // Reseta o valor para o banco padrão
...
function updateEditIcon() {
    ...
    const selectedBank = document.getElementById('editarNomeConta').value;
...
document.getElementById('salvarEdicaoConta').addEventListener('click', function () {
    ...
    const novoNome = document.getElementById('editarNomeConta').value;
